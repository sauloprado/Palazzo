...
add_filter( 'of_sanitize_slider', 'sanitize_text_field' );
...
add_filter( 'of_sanitize_tiles', 'of_sanitize_enum', 10, 2);

/* Icons */

add_filter( 'of_sanitize_carticon', 'of_sanitize_enum', 10, 2);
